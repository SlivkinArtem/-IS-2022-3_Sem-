...
{
    public WalkingShuttle(HullDurability hullDurability, Deflector? deflector, PhotonDeflector? photonDeflector,  Engine? engine, JumpEngine? jumpEngine, SizeType size) 
